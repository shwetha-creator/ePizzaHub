...
$(document).ready(function () {
    var cookie = $.cookie('CId');// here we are adding the jquery cookie so we need javascript file for 
                                  //jquery cookie that needs to be added in _FullSizeLayout.cshtml
    if (cookie) {
        $.ajax({
            type: "GET",
            contentType: "application/json; charset=utf-8",
